...
// ? SAME AS data-tech-validation.js, KEEP USING THIS ?
// VALIDATE SUGGESTION (BOTH POST AND PUT)
exports.validateSuggestion = async (req, res, next) => {
    try {
        let errors = [];
...
// VALIDATE RESPONSE SUGGESTION
exports.validateResponseSuggestion = (req, res, next) => {
    try {
        let errors = [];
